...
**"kose-scraper security"** in the subject — otherwise it lands in a queue
...
- **Bypassing Maison KOSÉ's bot protection.** This scraper drives an ordinary
...
- **The scraper stopped working.** Maison KOSÉ changing its markup is expected —

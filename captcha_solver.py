...
page. If Maison KOSÉ ever renders a reCAPTCHA challenge anywhere — account,
sign-in and checkout flows are the usual places — this fires.

**No challenge has been observed on this site at all.** Measured
2026-09-18 (see the README): zero captcha markers of any vendor across 13
captures — listings, product pages, the site's own 404 and an exhausted facet
alike. So this module is a contingency, not part of the happy path
...
# a JPEG of distorted text and a GET form). None of it is ported here,
# because Maison KOSÉ has no such page: 13 captures measured 2026-09-18
# carried no challenge of any kind (see the README).
#

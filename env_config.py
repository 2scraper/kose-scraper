...
ENV_KEYS = {
    ...
    "KOSE_CDP_ENDPOINT": "cdp_endpoint",
    "KOSE_PROXY": "proxy",
    "KOSE_URL": "url",
}
...
#
#     ws://{login}-zone-scraping_browser-country-de-pid-{profileId}:{password}@cb.2captcha.com:9222
...
def unknown_keys(path=None):
    ...
    Usually a typo — `TWO_CAPTCHA_KEY`, `KOSE_CDP` — which otherwise fails
